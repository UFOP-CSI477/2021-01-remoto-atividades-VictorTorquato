...
@section('content')
    ...
    <div class="container">
        ...
        <h3 style="margin-top: 2rem">Insira os dados do tipo de protocolo: </h3>

        <form method="post" action="{{ route('subject.store') }}">
        @csrf
            <div class="form-group column">
                <label for="nameInput">Nome do tipo</label>
                <input class="form-control" required="true" type="text" name="name" id="nameInput"/>
            </div>
            
            <div class="form-group column">
                <label for="priceInput">Preço do tipo</label>
                <input class="form-control" required="true" type="number" name="price" id="priceInput"></textarea>
            </div>
